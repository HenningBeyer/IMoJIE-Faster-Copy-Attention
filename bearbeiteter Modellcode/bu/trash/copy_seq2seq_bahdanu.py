...
class CopyNetSeq2Seq(Model):
    ...
    def __init__(self,
                 ...
                 reduced_copy_attention : bool = False,
    ...
    def _encode(self, source_tokens: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        try:
            ...
            ipdb.set_trace()
        print(f'embeddtime : {time.time()-t1} s')
        print(f'test_counter {est_counter}')
        if test_counter > 4:
            raise RuntimeError('ftdfjknbepolknkojrejnbfkjnfnjokjkoekeofjbfgjepok')
        test_counter += 1
    ...
    def _get_input_and_selective_weights(self,
        ...
        if self._selective_read_out_of_n_last_extr: 
