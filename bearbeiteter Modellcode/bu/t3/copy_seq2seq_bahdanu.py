...
class CopyNetSeq2Seq(Model):
    ...
    def __init__(self,
                 ...
                 forced_sel_read_from_input_sent: bool = True    ) -> None:
        ...
        elif add_copy_to_gen_log_probs and do_combine_copy_log_probs:
    ...
    def test_append(self, source_tokens, source_token_ids, source_to_target):
        ...
        stop = False   
        global num_extractions #global for knowing the extr.-num for _copy_out_of_n_last_extr and _selective_read_out_of_n_last_extr
        num_extractions = 0
    ...
    def _gather_final_log_probs(self,
        ...
        """
        t1 = time.time()
        if (not self._reduced_copy_attention) and self._copy_out_of_n_last_extr >= num_extractions:  
            ...
            if self._add_copy_to_gen_log_probs:
                ...
                pass
                #gflp for input
                if self._copy_out_of_n_last_extr > 0:
                    self._copy_out_of_n_last_extr >= num_extractions:
                        self._reduced_copy_attention = 
                    pass
                    #glfp for last extrac
